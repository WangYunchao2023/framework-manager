...
#   Qwen3.6-35B-A3B-Uncensored-... -> qwen3.6-uncensored
...
if re.search(r'qwen[0-9.]+-[0-9]+b-a[0-9]+b[-_]?(uncensored|abliterated)', name.lower()):
    ver = re.match(r'qwen([0-9.]+)', name.lower()).group(1)
    print(f'qwen{ver}-uncensored'); exit()
print('')
" 2>/dev/null)
